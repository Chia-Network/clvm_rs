...
pub fn node_from_stream(allocator: &mut Allocator, f: &mut Cursor<&[u8]>) -> CLVMResult<NodePtr> {
...
pub fn node_from_bytes(allocator: &mut Allocator, b: &[u8]) -> CLVMResult<NodePtr> {
