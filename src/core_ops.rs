...
pub fn op_if(a: &mut IntAllocator, input: NodePtr, _max_cost: Cost) -> Response<NodePtr> {
...
pub fn op_cons(a: &mut IntAllocator, input: NodePtr, _max_cost: Cost) -> Response<NodePtr> {
    let args = Node::new(a, input);
...
pub fn op_first(a: &mut IntAllocator, input: NodePtr, _max_cost: Cost) -> Response<NodePtr> {
    let args = Node::new(a, input);
    check_arg_count(&args, 1, "f")?;
    Ok(Reduction(FIRST_COST, args.first()?.first()?.node))
}

pub fn op_rest(a: &mut IntAllocator, input: NodePtr, _max_cost: Cost) -> Response<NodePtr> {
    let args = Node::new(a, input);
    check_arg_count(&args, 1, "r")?;
    Ok(Reduction(REST_COST, args.first()?.rest()?.node))
}

pub fn op_listp(a: &mut IntAllocator, input: NodePtr, _max_cost: Cost) -> Response<NodePtr> {
    let args = Node::new(a, input);
...
pub fn op_raise(a: &mut IntAllocator, input: NodePtr, _max_cost: Cost) -> Response<NodePtr> {
    let args = Node::new(a, input);
    args.err("clvm raise")
}

pub fn op_eq(a: &mut IntAllocator, input: NodePtr, _max_cost: Cost) -> Response<NodePtr> {
    let args = Node::new(a, input);
